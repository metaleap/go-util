...
```
Converts src to dst. If sparse is true, then only successfully converted bool
values are placed in dst, so there may not be a 1-to-1 correspondence of dst to
src in length or indices. If sparse is false, dst has the same length as src and
non-convertable values remain zeroed.
...
```
Calls BoolSetCap() only if the current capacity of *ref is less than the
specified capacity.
...
```
Calls BoolSetLen only if the current length of *ref is less than the specified
length.
...
```
Removes the first occurrence of v encountered in *ref, or all occurrences if all
is true.
...
```
Converts src to dst. If sparse is true, then only successfully converted float64
values are placed in dst, so there may not be a 1-to-1 correspondence of dst to
src in length or indices. If sparse is false, dst has the same length as src and
non-convertable values remain zeroed.
...
```
Calls F64SetCap() only if the current capacity of *ref is less than the
specified capacity.
...
```
Calls F64SetLen only if the current length of *ref is less than the specified
length.
...
```
Converts src to dst. If sparse is true, then only successfully converted int
values are placed in dst, so there may not be a 1-to-1 correspondence of dst to
src in length or indices. If sparse is false, dst has the same length as src and
non-convertable values remain zeroed.
...
```
Calls IntSetCap() only if the current capacity of *ref is less than the
specified capacity.
...
```
Calls IntSetLen only if the current length of *ref is less than the specified
length.
...
```
Converts src to dst. If sparse is true, then only successfully converted string
values are placed in dst, so there may not be a 1-to-1 correspondence of dst to
src in length or indices. If sparse is false, dst has the same length as src and
non-convertable values remain zeroed.
...
```
Calls StrSetCap() only if the current capacity of *ref is less than the
specified capacity.
...
```
Calls StrSetLen only if the current length of *ref is less than the specified
length.
